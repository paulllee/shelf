    ...
    >
      <div className="flex justify-between items-start">
        ...
        {item.rating && item.rating !== "n/a" && (
          <span className="inline-grid place-items-center px-1.5 py-0.5 rounded-full text-[0.7rem] font-semibold leading-[1] tabular-nums bg-primary text-primary-content">{item.rating}</span>
        )}
      </div>
